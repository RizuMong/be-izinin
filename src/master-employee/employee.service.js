const { findAll, findById, findByNpk, createEmployee, deleteEmployee, updateEmployee } = require("./employee.repository");
...
const createEmployeeService = async (body) => {
    ...
    // FK validation
    await validateFK("master_site", site_id, "Site");
    await validateFK("master_afdeling", afdeling_id, "Afdeling");
    await validateFK("master_job_position", job_position_id, "Job Position");
